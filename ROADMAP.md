...
> 64 個 contract test 模組、648 項測試（647 passed + 1 skipped；不裝 `[rag]` extra 時 635 passed + 12 skipped）；schema migration 18/18。
...
- 程式面 P0–P8 ＋ 22 份 ADR 全部落地、648 項測試容器全綠；**功能已經夠多，缺的是減法。**
