        ...
        proposals.append(
            {
                ...
                "execution_available": True,
                "command": "antigravity --task 'Verify Browser Extension heartbeat and functionality'",
            ...
            proposals.append(
                {
                    ...
                    "execution_available": True,
                    "command": f"antigravity --task 'Review stalled open loops for project {project.project_key}'",
                    "evidence_refs": evidence_refs,
                    "evidence": evidence,
