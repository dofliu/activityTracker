...
- [x] 59 個 contract tests 通過；Python compile、Extension JS syntax、TOML/YAML parse 與 diff check 通過。
...
- [ ] Windows/macOS/Linux × Python 3.10/3.12 GitHub Actions matrix 通過（workflow 已建立，待 push receipt）。
