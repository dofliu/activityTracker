...
6. [x] verified backup copy upgrade + restore drill 通過後，才執行 live upgrade；2026-08-25 semantic index/provenance migrations 後 live DB 現為 7/7，post-P3 backup/restore drill 通過。
