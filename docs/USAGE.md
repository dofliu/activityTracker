...
### 會議秘書：會後把逐字稿變成紀錄與候選待辦（2026-09-08，ADR-022）
...
### 每日工作誌：讓小秘書真的知道你每天做了什麼（2026-09-05，ADR-012 Addendum A）
...
### 模式感知提案：秘書開始注意你的習慣（2026-09-05，ADR-017）
...
### 告訴秘書你在乎什麼、想怎麼被講話（2026-09-05，ADR-018）
...
### 秘書桌面：01 是首頁，其他分頁是詳情（2026-09-05，ADR-019）

打開 01，問候卡下面多了一張**秘書桌面**。它不是新的資料，而是秘書從既有的東西裡**挑出現在該看的**：
...
**版面（2026-09-06 依實機回饋調整）**：01 只剩兩塊——左邊秘書桌面（問候併在最上面，今天／近 2 小時切換與 ↻ 在桌面標題列），右邊交辦與提問（記憶區併在下面）——在 1080p 與 1440×900 不用捲動就看完。原本右欄的「今日統計」「FOCUS NOW」搬到 05 摘要與統計最上方，「DATA TRUST」搬到 06 系統設定 → 系統健康。
...
### 每週回顧：說的 vs 做的（2026-09-06，ADR-020）
