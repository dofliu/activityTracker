...
| 測試 | **71 個 contract test 模組、776 項**（775 passed + 1 skipped；**不裝 `[rag]` extra 時 762 passed + 13 skipped**，CI 有一個 job 專跑這個）。容器缺 xdg-open 時 `test_open_command_is_argv_not_shell_string` 會條件 skip 並標註原因，不是失敗。 |
