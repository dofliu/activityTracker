...
- **測試**:404 項 contract tests(403 passed + 1 skipped);容器/雲端環境缺 xdg-open 時 `test_open_command_is_argv_not_shell_string` 會條件 skip 並標註原因,不再是失敗。
