...
| 測試 | **72 個 contract test 模組、796 項**（795 passed + 1 skipped；不裝 `[rag]` extra 時 782 passed + 13 skipped）；Windows／Ubuntu／macOS × Python 3.10／3.12 CI 六個 job ＋ 一個「不裝 `[rag]`」job 全綠 |
...
├── tests/                      # 72 個 contract test 模組（796 項）
