...
| 測試 | **73 個 contract test 模組、807 項**（806 passed + 1 skipped；不裝 `[rag]` extra 時 793 passed + 13 skipped）；Windows／Ubuntu／macOS × Python 3.10／3.12 CI 六個 job ＋ 一個「不裝 `[rag]`」job 全綠 |
...
├── tests/                      # 73 個 contract test 模組（807 項）
